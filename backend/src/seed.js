export const defaultPlano = [
  ...
  { cat: 'DESPESAS FIXAS', grp: 'Pessoal', tipo: 'Salários e Encargos', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS FIXAS', grp: 'Pessoal', tipo: 'Benefícios', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS FIXAS', grp: 'Pessoal', tipo: 'Pró-labore', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS FIXAS', grp: 'Estrutura', tipo: 'Aluguel', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS FIXAS', grp: 'Estrutura', tipo: 'Energia e Utilities', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS FIXAS', grp: 'Estrutura', tipo: 'Telefone e Internet', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS FIXAS', grp: 'Estrutura', tipo: 'Material de Escritório', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS FIXAS', grp: 'Tecnologia', tipo: 'Softwares e Licenças', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS FIXAS', grp: 'Tecnologia', tipo: 'Infraestrutura de TI', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS VARIÁVEIS', grp: 'Comercial', tipo: 'Marketing e Publicidade', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS VARIÁVEIS', grp: 'Comercial', tipo: 'Comissões de Vendas', nivel: 'Despesa Operacional' },
  { cat: 'DESPESAS VARIÁVEIS', grp: 'Comercial', tipo: 'Fretes e Logística', nivel: 'Despesa Operacional' },
